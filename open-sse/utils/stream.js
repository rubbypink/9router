...
export function createSSEStream(options = {}) {
  const {
    ...
    apiKey = null,
    geminiContinuationContext = null,
  } = options;
  ...
  const state = mode === STREAM_MODE.TRANSLATE
    ? { ...initState(sourceFormat), provider, toolNameMap, model, geminiContinuationContext }
    : null;
    ...
    transform(chunk, controller) {
      ...
      for (const line of lines) {
        ...
        if (mode === STREAM_MODE.PASSTHROUGH) {
          ...
          if (isDoneLine) streamDoneSent = true;
...
export function createSSETransformStreamWithLogger(targetFormat, sourceFormat, provider = null, reqLogger = null, toolNameMap = null, model = null, connectionId = null, body = null, onStreamComplete = null, apiKey = null, geminiContinuationContext = null) {
